    ...
    if (bookList.length === 0) {
        ...
        <div class="card h-100 border border-5 border-info bg-info">
            ...
            <div class="card-body">
                ...
                <h4 class=""><span class="text-danger fw-bold">Author:</span> ${book.author_name ? book.author_name: 'N/A'}</h4>
                <h5 class=""><span class="text-danger fw-bold">First-Publish-Year:</span> ${book.first_publish_year ? book.first_publish_year: 'N/A'}</h5>
